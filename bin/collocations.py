...
sys.stderr.write( "Step #1 of 4: Reading corpus\n" )
...
# get stopwords
sys.stderr.write( "Step #2 of 4: Reading stop words\n" )
...
sys.stderr.write( "Step #3 of 4: Modeling\n" )
...
sys.stderr.write( "Step #4 of 4: Reading model\n" )
...
for collocation in collocations :
	...
	if ( first.count( STEM ) > 0 ) or ( second.count( STEM ) > 0 )  :
